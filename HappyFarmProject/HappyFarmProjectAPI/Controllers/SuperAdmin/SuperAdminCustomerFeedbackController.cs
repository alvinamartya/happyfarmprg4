...
{
    public class SuperAdminCustomerFeedbackController : ApiController
    {
        #region Variable
        // logic
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("api/v1/SA/CustomerFeedback/{id}")]
        [HttpGet]
        public async Task<IHttpActionResult> GetCustomerFeedbackById(int id)
        {
            ...
            {
                // validate data
                ResponseModel responseModel = customerFeedbackLogic.GetCustomerFeedbackById(id, "Super Admin");
        ...
        /// <returns></returns>
        [Route("api/v1/SA/CustomerFeedback")]
        [HttpPost]
