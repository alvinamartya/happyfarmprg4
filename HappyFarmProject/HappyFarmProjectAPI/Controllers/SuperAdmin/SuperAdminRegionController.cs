...
{
    public class SuperAdminRegionController : ApiController
    {
        #region Variable
        // logic
        ...
        #region Action
        /// <summary>
        /// To delete region using super admin
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("api/v1/SA/Region/Delete/{id}")]
        [HttpDelete]
        public async Task<IHttpActionResult> DeleteRegion(int id)
        {
            ...
            {
                // validate data
                ResponseModel responseModel = regionLogic.GetRegionById(id, "Super Admin");
        ...
        /// <summary>
        /// To edit region using super admin account
        /// </summary>
        /// <param name="id"></param>
        /// <param name="regionRequest"></param>
        /// <returns></returns>
        [Route("api/v1/SA/Region/Edit/{id}")]
        [HttpPut]
