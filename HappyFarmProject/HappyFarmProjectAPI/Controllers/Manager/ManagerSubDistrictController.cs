...
{
    public class ManagerSubDistrictController : ApiController
    {
        #region Variable
        // logic
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("api/v1/Manager/SubDistrict/Delete/{id}")]
        [HttpDelete]
        public async Task<IHttpActionResult> DeleteSubDistrict(int id)
        {
            ...
            {
                // validate data
                ResponseModel responseModel = subDistrictLogic.GetSubDistrictById(id, "Manager");
        ...
        /// <summary>
        /// To edit sub district using manager account
        /// </summary>
        /// <param name="id"></param>
        ...
        /// <summary>
        /// To create new sub district using manager account
        /// </summary>
        /// <param name=""></param>
        /// <returns></returns>
        [Route("api/v1/Manager/SubDistrict/Add")]
        [HttpPost]
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [Route("api/v1/Manager/SubDistrict/{id}")]
        [HttpGet]
        ...
        /// <returns></returns>
        [Route("api/v1/Manager/SubDistrict")]
        [HttpPost]
