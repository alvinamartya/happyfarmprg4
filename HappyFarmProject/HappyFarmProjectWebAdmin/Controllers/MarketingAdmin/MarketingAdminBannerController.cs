...
{
    public class MarketingAdminBannerController : Controller
    {
        #region Variable
        HttpClient hcBannerAdd = APIHelper.GetHttpClient(APIHelper.MA + "/Banner/Add");
        HttpClient hcBannerDelete = APIHelper.GetHttpClient(APIHelper.MA + "/Banner/Delete");
        HttpClient hcBannerEdit = APIHelper.GetHttpClient(APIHelper.MA + "/Banner/Edit");
        #endregion
        #region GetBanner
        // GET Banner
        [Route("~/MA/Banner")]
        ...
        public ActionResult Edit(int id)
        {
            ...
            // get goods
            HttpClient hcBannerGet = APIHelper.GetHttpClient(APIHelper.MA + "/Banner");
        ...
        {
            // get categories
            HttpClient hcCategories = APIHelper.GetHttpClient(APIHelper.MA + "/Promo");
