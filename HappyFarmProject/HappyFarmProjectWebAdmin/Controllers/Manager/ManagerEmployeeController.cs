...
namespace HappyFarmProjectWebAdmin.Controllers
{
    ...
    {
        #region Variable
        HttpClient hcEmployeeAdd = APIHelper.GetHttpClient(APIHelper.Manager + "/Employee/Add");
        HttpClient hcEmployeeDelete = APIHelper.GetHttpClient(APIHelper.Manager + "/Employee/Delete");
        HttpClient hcEmployeeEdit = APIHelper.GetHttpClient(APIHelper.Manager + "/Employee/Edit");
        #endregion

        #region GetEmployees
        // GET Employees
        [Route("~/Manager/Karyawan")]
        [HttpGet]
        ...
        [Route("~/Manager/Karyawan/Ubah/{id}")]
        [HttpGet]
        public ActionResult Edit(int id)
        {
            ...
            // get employee
            HttpClient hcEmployeeGet = APIHelper.GetHttpClient(APIHelper.Manager + "/Employee");
        ...
        {
            // get Role
            HttpClient hcRole = APIHelper.GetHttpClient(APIHelper.Manager + "/Role");
        ...
        {
            // get regions
            HttpClient hcRegion = APIHelper.GetHttpClient(APIHelper.Manager + "/Region");
