...
{
    public class ManagerSubDistrictController : Controller
    {
        #region Variable
        HttpClient hcSubDistrictAdd = APIHelper.GetHttpClient(APIHelper.Manager + "/SubDistrict/Add");
        HttpClient hcSubDistrictDelete = APIHelper.GetHttpClient(APIHelper.Manager + "/SubDistrict/Delete");
        HttpClient hcSubDistrictEdit = APIHelper.GetHttpClient(APIHelper.Manager + "/SubDistrict/Edit");
        #endregion
        ...
        // Add SubDistrict
        [Route("~/Manager/Kecamatan/Tambah")]
        [HttpGet]
        ...
        [Route("~/Manager/Kecamatan/Ubah/{id}")]
        [HttpGet]
        public ActionResult Edit(int id)
        {
            ...
            // get subDistrict
            HttpClient hcSubDistrictGet = APIHelper.GetHttpClient(APIHelper.Manager + "/SubDistrict");
