...
namespace HappyFarmProjectWebAdmin.Controllers
{
    ...
    {
        #region Variable
        private HttpClient hc = APIHelper.GetHttpClient("User/Employee/ForgotPassword");
        #endregion
        ...
        [HttpPost]
        public ActionResult ForgotPassword(ForgotPasswordRequest forgotPassword)
        {
            ...
            {
                var apiForgotPassword = hc.PostAsJsonAsync<ForgotPasswordRequest>("ForgotPassword", forgotPassword);
